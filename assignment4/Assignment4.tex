...
\section{Solution}
Let $\vec{A} = \myvec{x\\y}$ be the point. The equation of y-axis is given by
\begin{equation}
    \vec{R} = \lambda \myvec{0\\1}
\end{equation}
AR is perpendicular to y-axis.
\begin{align}
    \implies &(\vec{R} - \vec{A})\cdot \vec{R} = 0\\
    \implies &(\lambda - y)\times \lambda = 0\\
    \implies &\lambda = y
\end{align}
...
We are given AR = AC.  
\begin{align}
    \implies x &= \sqrt{((x-2)^2+(y-1)^2)}\\
    \implies x^2 &= x^2-4x+4+y^2-2y+1\\
