...
\end{lemma}
\begin{proof}
We shall verify equation \eqref{synthesis}. 
\begin{align}
...
\end{equation}
Continuing from equation \eqref{an},
\begin{align}
...
\end{align}
\end{proof}
Let $S(f)$ be the Fourier transform of s(t). Then using the above lemma and equation \eqref{series}
\begin{equation}
    S(f) = \dfrac{1}{T_0}\sum_{n=-\infty}^{\infty}\delta\brak{f-\dfrac{n}{T_0}}\label{T_0}
\end{equation}
We can also write equation \eqref{T_0} by substituting $f_0 = \dfrac{1}{T_0}$ as
\begin{equation}
