...
\begin{lemma}
The Fourier transform of $\exp \brak{j\omega_0t}$ is $2\pi \delta(\omega-\omega_0)$.
\end{lemma}
\begin{proof}
We verify the lemma by finding the inverse Fourier transform of $2\pi \delta(\omega-\omega_0)$.
\begin{align}
    \dfrac{1}{2\pi}\int_{-\infty}^{\infty}2\pi \delta(\omega-\omega_0)\exp \brak{j\omega t}d\omega = \exp \brak{j\omega_0 t}
\end{align}
\end{proof}
Let $S(\omega)$ be the Fourier transform of s(t). Then using the above lemma and equation \ref{series}
\begin{equation}
    S(\omega) = \dfrac{2\pi}{T_0}\sum_{n=-\infty}^{\infty}\delta\brak{\omega-\dfrac{2\pi n}{T_0}}
\end{equation}
We can also write the above by substituting $\omega_0 = \frac{2\pi}{T_0}$ as
\begin{equation}
    S(\omega) = \sum_{n=-\infty}^{\infty}\omega_0\delta\brak{\omega-n\omega_0}
\end{equation}
